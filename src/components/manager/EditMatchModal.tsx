    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 w-full max-w-md mx-4 transform animate-scale-in">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-[#000000] mb-2">{t('manager.editMatch.title')}</h2>
          <p className="text-[#000000]">{t('manager.editMatch.description')}</p>
        </div>
        ...
        <div className="space-y-4 mb-8">
          ...
          >
            <div className="flex items-center justify-center gap-2 sm:gap-3">
              ...
              <span>{t('manager.editMatch.editMembers')}</span>
            </div>
          </button>
          ...
          >
            <div className="flex items-center justify-center gap-2 sm:gap-3">
              ...
              <span>{t('manager.editMatch.editScores')}</span>
            </div>
          </button>
        </div>
