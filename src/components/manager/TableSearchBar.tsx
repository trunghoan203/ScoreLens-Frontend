  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
      <div className="flex items-center border border-gray-300 bg-gray-100 rounded-lg px-3 sm:px-4 py-2 w-full sm:w-80 lg:w-96">
        <input
          type="text"
          placeholder={t('manager.tableSearch.placeholder')}
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
        <div className="relative w-full sm:w-44">
          ...
          >
            <option value="">{t('manager.tableSearch.all')}</option>
            <option value="pool-8">{t('manager.tableSearch.pool8')}</option>
            <option value="carom">{t('manager.tableSearch.carom')}</option>
          </select>
        ...
        >
          {t('manager.tableSearch.addTable')}
        </button>
      </div>
    </div>
  );
