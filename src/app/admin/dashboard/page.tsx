...
export default function DashboardPage() {
  ...
  const getStatusTranslationKey = (status: string) => {
    switch (status) {
      case 'Đang sử dụng':
        return t('adminDashboard.inUse');
      case 'Trống':
        return t('adminDashboard.empty');
      case 'Bảo trì':
        return t('adminDashboard.maintenance');
      default:
        return status;
    }
  };
  ...
  if (isLoadingDashboard && !dashboardData) {
    return (
      <>
        <ScoreLensLoading text={t('adminDashboard.loading')} />
            ...
            <div className="w-full mx-auto">
              <div className="flex items-center justify-center py-20">
                <div className="text-center">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">{t('adminDashboard.errorTitle')}</h2>
          ...
          <div className="w-full mx-auto">
            <div className="w-full rounded-xl bg-lime-400 shadow-lg py-4 sm:py-6 flex items-center justify-center mb-6 sm:mb-8 ">
              <span className="text-xl sm:text-2xl font-extrabold text-white tracking-widest flex items-center gap-2 sm:gap-3">
                {t('adminDashboard.adminDashboardTitle')}
              </span>
            </div>
            ...
            {!hasData ? (
              <EmptyState
                ...
                title={t('adminDashboard.noDataTitle')}
                description={t('adminDashboard.noDataDesc')}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                  <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <div className="relative p-6">
                      ...
                      <div className="text-center mb-4">
                        <h3 className="text-lg font-semibold text-blue-800 mb-2">{t('adminDashboard.totalBranchesCard')}</h3>
                      ...
                      <div className="flex justify-center gap-4 mt-6">
                        <div className="text-center">
                          ...
                          <div className="text-xs text-blue-600 font-medium mt-1">{t('adminDashboard.activeBranches')}</div>
                        </div>
                        <div className="w-px bg-blue-200"></div>
                        <div className="text-center">
                          <div className="text-2xl font-bold text-blue-700">{stats.closedBranches}</div>
                          <div className="text-xs text-blue-600 font-medium mt-1">{t('adminDashboard.closedBranches')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-50 to-green-100 border border-green-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <div className="relative p-6">
                      {/* Header */}
                      <div className="text-center mb-4">
                        <h3 className="text-lg font-semibold text-green-800 mb-2">{t('adminDashboard.totalTablesCard')}</h3>
                      ...
                      <div className="flex justify-center gap-3 mt-6">
                        <div className="text-center flex-1">
                          ...
                          <div className="text-xs text-green-600 font-medium mt-1">{t('adminDashboard.activeTables')}</div>
                        </div>
                        <div className="w-px bg-green-200"></div>
                        <div className="text-center flex-1">
                          <div className="text-xl font-bold text-gray-700">{stats.availableTables}</div>
                          <div className="text-xs text-gray-600 font-medium mt-1">{t('adminDashboard.emptyTables')}</div>
                        </div>
                        <div className="w-px bg-green-200"></div>
                        <div className="text-center flex-1">
                          <div className="text-xl font-bold text-yellow-700">{stats.maintenanceTables}</div>
                          <div className="text-xs text-yellow-600 font-medium mt-1">{t('adminDashboard.maintenanceTables')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <div className="relative p-6">
                      {/* Header */}
                      <div className="text-center mb-4">
                        <h3 className="text-lg font-semibold text-purple-800 mb-2">{t('adminDashboard.totalManagersCard')}</h3>
                      ...
                      <div className="flex justify-center gap-4 mt-6">
                        <div className="text-center">
                          ...
                          <div className="text-xs text-purple-600 font-medium mt-1">{t('adminDashboard.workingManagers')}</div>
                        </div>
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-xs text-gray-600 font-medium mt-1">{t('adminDashboard.onLeaveManagers')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <div className="relative p-6">
                      {/* Header */}
                      <div className="text-center mb-4">
                        <h3 className="text-lg font-semibold text-orange-800 mb-2">{t('adminDashboard.totalFeedbacksCard')}</h3>
                      ...
                      <div className="flex justify-center gap-4 mt-6">
                        <div className="text-center">
                          ...
                          <div className="text-xs text-orange-600 font-medium mt-1">{t('adminDashboard.pendingFeedbacksCard')}</div>
                        </div>
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-xs text-gray-600 font-medium mt-1">{t('adminDashboard.resolvedFeedbacks')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                    <div className="p-6 pb-4 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-gray-200">
                      <div className="flex items-center space-x-3">
                        <div>
                          <h3 className="text-lg font-bold text-gray-900">{t('adminDashboard.branchComparison')}</h3>
                          <p className="text-sm text-gray-600">{t('adminDashboard.branchComparisonDesc')}</p>
                        </div>
                      </div>
                    </div>
                    <div className="p-6">
                      {branchChartData.length > 0 ? (
                        <ResponsiveContainer width="100%" height={300}>
                          <BarChart data={branchChartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                            ...
                            />
                            <Bar dataKey="tables" fill="#10B981" radius={[4, 4, 0, 0]} name={t('adminDashboard.totalTablesCard')} />
                            <Bar dataKey="managers" fill="#3B82F6" radius={[4, 4, 0, 0]} name={t('adminDashboard.totalManagersCard')} />
                          </BarChart>
                        </ResponsiveContainer>
                      ) : (
                        <div className="flex items-center justify-center h-[300px] text-gray-500">
                          <div className="text-center">
                            ...
                            <p>{t('adminDashboard.chartNoData')}</p>
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                    <div className="p-6 pb-4 bg-gradient-to-r from-green-50 to-green-100 border-b border-gray-200">
                      <div className="flex items-center space-x-3">
                        <div>
                          <h3 className="text-lg font-bold text-gray-900">{t('adminDashboard.tableStatus')}</h3>
                          <p className="text-sm text-gray-600">{t('adminDashboard.tableStatusDesc')}</p>
                        </div>
                      </div>
                    </div>
                    <div className="p-6">
                      ...
                      <div className="flex items-center space-x-4">
                        <div>
                          <h3 className="text-xl sm:text-2xl font-bold text-gray-900">
                            {t('adminDashboard.branchStatistics')}
                          </h3>
                          <p className="text-sm text-gray-600 mt-1">{t('adminDashboard.branchStatisticsDesc')}</p>
                        </div>
                      </div>
                    </div>
                    <div className="p-6">
                              ...
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                                <div className="flex items-center space-x-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">{t('adminDashboard.branchNumber').replace('{number}', (index + 1).toString())}</p>
                                  </div>
                                </div>
                                <div className="flex flex-wrap gap-3">
                                  <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-300 hover:bg-blue-100 transition-all duration-200 shadow-sm">
                                    ...
                                    {branch.totalTables} {t('adminDashboard.tables')}
                                  </Badge>
                                  <Badge variant="outline" className="bg-green-50 text-green-700 border-green-300 hover:bg-green-100 transition-all duration-200 shadow-sm">
                                    ...
                                    {branch.totalManagers} {t('adminDashboard.managers')}
                                  </Badge>
                                </div>
                              </div>
                                  ...
                                  <div className="relative">
                                    ...
                                    <div className="flex justify-between items-center">
                                      <div className="text-center">
                                        ...
                                        <div className="text-xs text-gray-500 font-medium">{t('adminDashboard.inUse')}</div>
                                      </div>
                                      <div className="w-px h-12 bg-gray-300"></div>
                                      <div className="text-center">
                                        <div className="text-2xl font-bold text-gray-600">{branch.emptyTables}</div>
                                        <div className="text-xs text-gray-500 font-medium">{t('adminDashboard.empty')}</div>
                                      </div>
                                      <div className="w-px h-12 bg-gray-300"></div>
                                      <div className="text-center">
                                        <div className="text-2xl font-bold text-gray-600">{branch.maintenanceTables}</div>
                                        <div className="text-xs text-gray-500 font-medium">{t('adminDashboard.maintenance')}</div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="group/manager relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200 hover:border-blue-300 transition-all duration-300">
                                  ...
                                  <div className="relative">
                                    <h4 className="text-sm font-semibold text-gray-700 flex items-center mb-4">
                                      ...
                                      {t('adminDashboard.managerStatus')}
                                    </h4>
                                    <div className="flex justify-between items-center">
                                      <div className="text-center">
                                        <div className="text-2xl font-bold text-blue-600">{branch.workingManagers}</div>
                                        <div className="text-xs text-gray-500 font-medium">{t('adminDashboard.working')}</div>
                                      </div>
                                      <div className="w-px h-12 bg-gray-300"></div>
                                      <div className="text-center">
                                        <div className="text-2xl font-bold text-gray-600">{branch.onLeaveManagers}</div>
                                        <div className="text-xs text-gray-500 font-medium">{t('adminDashboard.onLeave')}</div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
