...
export function GuestLoginPageClient() {
        ...
        <div className="flex flex-col min-h-screen bg-gradient-to-b from-white to-gray-100 px-4">
            ...
            <div className="w-full p-4 bg-white shadow-inner">
                <button
                    ...
                    className="w-full bg-lime-500 hover:bg-lime-600 text-white font-semibold py-3 rounded-xl text-base sm:text-lg transition disabled:bg-gray-400"
                >
                    Tiếp tục
                </button>
            </div>
