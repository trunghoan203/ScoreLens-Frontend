 ...
 //Super Admin
    ...
    // Super Admin Verification Page
        superAdminVerification: {
            ...
            verificationInvalid: 'Mã xác thực không hợp lệ',
    ...
    // Super Admin Home Page
        superAdminHome: {
            // Admin tab
            adminListTitle: 'DANH SÁCH CHỦ DOANH NGHIỆP',
...
// Admin
    ...
    // Brand Information Register Form
        brandInfoForm: {
    ...
    // Club Information Register Form
        clubInfoForm: {
            title: 'Thông tin chi nhánh',
            backToPrevious: '← Quay lại bước trước',
            club: 'Chi nhánh',
            addClub: 'Thêm chi nhánh',
            removeClub: 'Xóa chi nhánh',
            ...
            clubInfoTitle: 'Thông tin chi nhánh',
    ...
    // Clubs Management Page
        clubs: {
            ...
            cannotLoadClubs: 'Không thể tải danh sách chi nhánh',
            searchError: 'Lỗi tìm kiếm',
            noSearchResults: 'Không tìm thấy chi nhánh phù hợp',
            noClubs: 'Chưa có chi nhánh nào',
            ...
            detailPage: {
                title: 'CHI NHÁNH',
                editClub: 'CHỈNH SỬA CHI NHÁNH',
                clubDetails: 'CHI TIẾT CHI NHÁNH',
                backToClubs: 'Quay lại',
                edit: 'Chỉnh sửa',
                saving: 'Đang lưu...',
                save: 'Lưu',
                delete: 'Xóa',
                ...
                cannotLoadClub: 'Không thể tải thông tin chi nhánh',
                updateSuccess: 'Cập nhật chi nhánh thành công!',
                updateFailed: 'Cập nhật chi nhánh thất bại',
                deleteSuccess: 'Xóa chi nhánh thành công!',
                deleteFailed: 'Xóa chi nhánh thất bại',
                clubNotFound: 'Không tìm thấy thông tin chi nhánh',
...
// Manager
    ...
    // Manager Login Page
        managerLogin: {
            ...
            managerNotFound: 'Quản lý không tồn tại',
        },

    // Manager Verification Page
        managerVerification: {
